...
COMSCORE.SiteRecruit.Broker.config = {
  ...
  ,{m: '//[\\w\\.-]+/en-us/cloud-platform', c: 'inv_c_p218292485-3105.js', f: 0.5, p: 0  }  
	,{m: '//[\\w\\.-]+/(en-us/download)|(download/(en/|.*?displaylang=en))', c: 'inv_c_p246609455-1345.js', f: 0.0364, p: 1 }
	...
	,{m: '//[\\w\\.-]+/en-us/windows/10', c: 'inv_c_p346322309-3064.js', f: 0.0, p: 0, halt:true  }

	,{m: 'int\_cle.htm.+/en-us/windows/10.*site=3064', c: 'inv_c_p346322309-3064-CLE.js', f: 0.0, p: 5, halt:true, prereqs:{content:[],cookie:[{'name':'srOS','value':'mac'}]}}
	,{m: 'int\_cle.htm.+/en-us/windows/10.*site=3064', c: 'inv_c_p346322309-3064-CLE.js', f: 0.0, p: 3, halt:true }
